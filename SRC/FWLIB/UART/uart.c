...
void UART_ITConfig(UART_Type* UARTx, uint16_t UART_IT, FunctionalState NewState)
{
    ...
    switch((uint32_t)UARTx)
		{
       case UART0_BASE :NVIC_EnableIRQ(UART0_RX_TX_IRQn);break;
			 case UART1_BASE :NVIC_EnableIRQ(UART1_RX_TX_IRQn);break;
			 case UART2_BASE :NVIC_EnableIRQ(UART2_RX_TX_IRQn);break;
		   case UART3_BASE :NVIC_EnableIRQ(UART3_RX_TX_IRQn);break;
			 case UART4_BASE :NVIC_EnableIRQ(UART4_RX_TX_IRQn);break;
			 case UART5_BASE :NVIC_EnableIRQ(UART5_RX_TX_IRQn);break;
			 default: break;
    }
  }
}
