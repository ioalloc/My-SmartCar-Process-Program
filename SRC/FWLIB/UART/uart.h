...
#define UART1_RX_PC3_TX_PC4      (0x0000C899U)
#define UART2_RX_PD2_TX_PD3      (0x000086DAU)
#define UART3_RX_PB10_TX_PB11    (0x0002965BU)
#define UART3_RX_PC16_TX_PC17    (0x0004229BU)
#define UART3_RX_PE4_TX_PE5      (0x00010B1BU)
#define UART4_RX_PE24_TX_PE25    (0x0006331CU)
#define UART4_RX_PC14_TX_PC15    (0x00039E9CU)
...
#define IS_UART_MAP(MAP)        (((MAP) == UART0_RX_PA1_TX_PA2)   || \
																...
																((MAP) == UART1_RX_PC3_TX_PC4)      || \
																((MAP) == UART2_RX_PD2_TX_PD3)      || \
																((MAP) == UART3_RX_PB10_TX_PB11)    || \
																((MAP) == UART3_RX_PC16_TX_PC17)    || \
																((MAP) == UART3_RX_PE4_TX_PE5)      || \
																((MAP) == UART4_RX_PE24_TX_PE25)    || \
																((MAP) == UART4_RX_PC14_TX_PC15))
//参数检查器														
